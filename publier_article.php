...
if(isset($_POST['envoi'])){
    if(!empty($_POST['titre']) and !empty($_POST['description'])and !empty($_POST['prix'])){
        ...
        $inserarticle =$bdd->prepare('INSERT INTO articles(titre,prix,description,image)VALUES(?,?,?,?)');
        $inserarticle->execute(array($titre,$prix,$description,$image));
        ?>
        ...
        ?>
        <script type="text/javascript">
        alert("completer tous les champes..");      
        </script><?php
}
}
?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="mb-0">Ajouter un article</h4>
                            </div>
                        </div>
                    </div>
                    <div class="card-body ">
