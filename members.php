...
<div id="container" class="pb-5 pt-5">
    <ul class="list-group list-group-horizontal" style="padding-top: 70px;"  >
        <li class="list-group-item active col-md-3" aria-current="true">Pseudo</li>
        <li class="list-group-item active col-md-3" aria-current="true">Mail</li>
        <li class="list-group-item active col-md-3" aria-current="true">Tel</li>
        <li class="list-group-item active col-md-3" aria-current="true">Address</li>
    </ul>
