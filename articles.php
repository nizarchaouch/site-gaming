        ...
        <div class="col-md-3 col-sm-6 my-3 my-md-2">
            <form action="" method="post">
                <div class="card shadow" style="height: 490px; border-radius: 20px; ">
                    <div class="card-header" id="img" style="border-top-right-radius:15px;border-top-left-radius:15px;"><img style="height: 200px; width: 370px;" src="<?php echo 'espace_client/images/'.$article['image'] ?>" class="img-fluid card-img-top" alt="product image"></div>
                    <div class="card-body">
                        ...
                        <button class="btn btn-warning my-3" type="submit" name="add">Ajouter au panier <i class="fas fa-shopping-cart"></i></button>
                    </div>
                </div>
            </form>
        </div>
