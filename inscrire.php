...
if (isset($_POST['valider'])) {
  ...
  $inserarticle = $bdd->prepare('INSERT INTO membres(pseudo,address,tel,mail,mdp,etat)VALUES(?,?,?,?,?,?)');
  $inserarticle->execute(array($pseudo, $address, $tel, $mail, $mdp, -1));
?>
            ...
            <div class="card bg-dark text-white" style="border-radius: 1rem;">
              <div class="card-body p-5 text-center">
                ...
                <div class="mb-md-5 pb-5">
                  ...
                  <button class="btn btn-outline-light btn-lg px-5" type="submit" name="valider">Enregistrer</button>
                ...
                <div>
                  <p class="mb-0"> <a href="connexion.php" class="text-white-50 fw-bold">Connexion</a>
                  </p>
                </div>
              </div>
            </div>
