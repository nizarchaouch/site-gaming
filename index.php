    ...
    <div class="row text-center ">
        ...
        <div class="col-md-3 col-sm-6 my-3 my-md-3">
                <div class="card shadow" style="height: 500px; border-radius: 20px;" >
                    <div id="img"style="border-top-right-radius:15px;border-top-left-radius:15px;" ><img style="height: 200px; width: 370px; " src="<?php echo 'espace_client/images/'.$article['image'] ?>" class="img-fluid card-img-top"  alt="product image"></div>
                    <div class="card-body">
                        <h5 class="card-title text-uppercase"  ><?php echo $article['titre'] ?></h5>
                        <h6>
                        ...
                        <a href="supprime_article.php?id=<?=$article['id'];?>">
                        <button class="btn btn-danger col-md-5" >supprime l'article</button></a>
                        <a href="modifier_article.php?id=<?=$article['id'];?>">
                        <button class="btn btn-warning col-md-5" >modifier l'article</button></a>
                    </div>
                </div>
        </div>
        <?php
