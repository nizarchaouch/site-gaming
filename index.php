        ...
        ?>
            <div class="col-md-3 col-sm-6 my-3 my-md-3">
                <div class="card shadow" style="height: 500px; border-radius: 20px;">
                    <div id="img" style="border-top-right-radius:15px;border-top-left-radius:15px;"><img
                            style="height: 200px; width: 370px; "
                            src="<?php echo 'espace_client/images/' . $article['image'] ?>" class="img-fluid card-img-top"
